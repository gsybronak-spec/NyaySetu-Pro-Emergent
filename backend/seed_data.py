...
try:
    ...
    TEMPLATES = [t for t in _TEST_TEMPLATES if t.get("id") in ("document_exhibit_application", "document_return_application", "certified_copy_application", "closing_purshish")]
except Exception:
    TEMPLATES = []
