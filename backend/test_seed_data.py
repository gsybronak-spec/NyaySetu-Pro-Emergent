...
""",
    ...
    {
        "id": "document_exhibit_application",
        ...
        "fields": [
            ...
            {"key": "case_number", "label_en": "Case Number", "label_gu": "કેસ નંબર", "type": "text", "required": True, "source": "case_number", "mode": ["saved_case", "direct_template"], "placeholder": "દા.ત. ૧૦૧/૨૦૨૪"},
            {
                "key": "party_1_role",
            ...
            {"key": "party_1_name", "label_en": "Party 1 Name", "label_gu": "પક્ષકાર - ૧ નું નામ", "type": "text", "required": True, "source": "case_party_name", "mode": ["saved_case", "direct_template"], "placeholder": "પક્ષકાર - ૧ નું નામ"},
            {
                "key": "party_2_role",
            ...
            {"key": "party_2_name", "label_en": "Party 2 Name", "label_gu": "પક્ષકાર - ૨ નું નામ", "type": "text", "required": True, "source": "case_opposite_party_name", "mode": ["saved_case", "direct_template"], "placeholder": "પક્ષકાર - ૨ નું નામ"},
            {
                "key": "representing_party",
                "label_en": "Advocate acting on behalf of",
                "label_gu": "કોના તરફે એડવોકેટ",
                "type": "select",
                "required": True,
                "options": [
                    {"value": "party_1", "label_en": "Applicant / Complainant / Plaintiff side", "label_gu": "ફરીયાદી / અરજદાર / વાદી તરફે"},
        ...
        "settings": {
            ...
            "block_align": [
                ...
                {"contains": "COURT OF", "align": "center", "bold": True},
                {"contains": "મુકામ :-", "align": "center"},
                {"contains": "Place:", "align": "center"},
                {"contains": " નં. :", "align": "right"},
                ...
                {"contains": "સદર કેસ આપ નામદાર", "align": "justify", "indent": True},
                {"contains": "In the above matter", "align": "justify", "indent": True},
                {"contains": "The above case is pending", "align": "justify", "indent": True},
                {"contains": "તારીખ :", "align": "left"},
...
Subject: Regarding marking the document(s) as exhibit(s)...
...
{{advocate_name}}""",
    ...
    {
        "id": "closing_argument_right_application",
        ...
        "fields": [
            ...
            {
                "key": "closed_party",
                "label_en": "Right-to-be-closed Party",
                "label_gu": "કોનો હક્ક ચાલુ છે જેબંધ કરવાનો છે",
                "type": "select",
                "required": False,
                "options": [
                    {"value": "આરોપી", "label_en": "Accused", "label_gu": "આરોપી"},
        ...
        "settings": {
            ...
            "first_line_indent_pt": 28.35,
            "block_align": [
                {"contains": "મુકામ :-", "align": "center", "bold": True, "indent": False},
                {"contains": "AT:", "align": "center", "bold": True, "indent": False},
                {"contains": "બાબત :- દલીલોનો હક બંધ કરવા બાબત", "align": "center", "bold": True, "underline": True, "indent": False},
                {"contains": "SUBJECT: APPLICATION FOR CLOSING THE RIGHT TO MAKE ARGUMENTS", "align": "center", "bold": True, "underline": True, "indent": False},
            ],
        },
        "content_gu": """મહેરબાન {{court}} સાહેબશ્રીની કોર્ટમાં,
મુકામ :- {{taluka_place}}
...
સદર કેસ આપ નામદાર કોર્ટમાં આજ રોજ દલીલો પર છે. પરંતુ સદર કેસમાં {{closed_party_role}} પોતે જાતે કે તેમના વકીલશ્રી આજરોજ આપ નામદાર કોર્ટમા હાજર ન હોઈ, તેમજ કોઈ મુદ્દત રીપોર્ટ રજુ કરેલ ન હોઈ જેથી {{closed_party_role}} નો દલીલો કરવાનો હક બંધ કરી આગળની ન્યાયિક કાર્યવાહી કરવા યોગ્ય તે હુકમ કરવા મહેરબાની કરશોજી.
...
SUBJECT: APPLICATION FOR CLOSING THE RIGHT TO MAKE ARGUMENTS...

In the present matter, we, the Advocate for {{advocate_for_role}}, respectfully submit before this Hon'ble Court that...

The present case is scheduled today for arguments before this Hon'ble Court. However, in the said case, {{closed_party_role}} personally or their advocate is not present before this Hon'ble Court today, nor has any adjournment report been submitted, therefore this Hon'ble Court may be pleased to close the right of {{closed_party_role}} to make arguments and pass appropriate orders to proceed further with the judicial proceedings.
...
{{advocate_name}}""",
    ...
    {
        "id": "reopen_right_to_argue_application",
        ...
        "aliases": [
            ...
            "દલીલો કરવાનો હક ફરીથી ખોલવા બાબત",
            "દલીલો કરવા નો હક ફરીથી ખોલવા બાબત",
            "દલીલોનો હક ખોલાવવાની અરજી",
            "હક ખોલવા અરજી",
            "હક ફરીથી ખોલવા",
        ],
        "fields": [
            ...
            },
            {
                ...
                "required": False,
                "options": [
                    {"value": "દલીલો તૈયાર ન હોવાના", "label_gu": "દલીલો તૈયાર ન હોવાના", "label_en": "દલીલો તૈયાર ન હોવાના"},
                    {"value": "અમો માંદગીના કારણોસર આપ નામદાર કોર્ટમાં આવી શકીએ તેમ ન હતા, જે", "label_gu": "અમો માંદગીના કારણોસર આપ નામદાર કોર્ટમાં આવી શકીએ તેમ ન હતા, જે", "label_en": "અમો માંદગીના કારણોસર આપ નામદાર કોર્ટમાં આવી શકીએ તેમ ન હતા, જે"},
                    {"value": "અમો સામાજીક કામે રોકાયેલ હોવાના કારણોસર આપ નામદાર કોર્ટમા આવી શકીએ તેમ ન હતા, જે", "label_gu": "અમો સામાજીક કામે રોકાયેલ હોવાના કારણોસર આપ નામદાર કોર્ટમા આવી શકીએ તેમ ન હતા, જે", "label_en": "અમો સામાજીક કામે રોકાયેલ હોવાના કારણોસર આપ નામદાર કોર્ટમા આવી શકીએ તેમ ન હતા, જે"},
                    {"value": "આરોપીના સગા ગુજરી ગયેલ, જે", "label_gu": "આરોપીના સગા ગુજરી ગયેલ, જે", "label_en": "આરોપીના સગા ગુજરી ગયેલ, જે"},
                    {"value": "આરોપીને વ્યવસાયના કામ અર્થે વિદેશ જવાનુ થયેલ, જે", "label_gu": "આરોપીને વ્યવસાયના કામ અર્થે વિદેશ જવાનુ થયેલ, જે", "label_en": "આરોપીને વ્યવસાયના કામ અર્થે વિદેશ જવાનુ થયેલ, જે"},
                    {"value": "આરોપી બીજા ગુન્હાના કામ અર્થે જેલમાં હોય, જે", "label_gu": "આરોપી બીજા ગુન્હાના કામ અર્થે જેલમાં હોય, જે", "label_en": "આરોપી બીજા ગુન્હાના કામ અર્થે જેલમાં હોય, જે"},
                    {"value": "અન્ય", "label_gu": "અન્ય", "label_en": "અન્ય"},
                ],
            },
            {
                "key": "date",
...
{{advocate_name}}""",
    },
    {
        ...
        "fields": [
            ...
            },
            {
                ...
                "options": [
                    ...
                    {"value": "special_civil_suit", "label_en": "Special Civil Suit", "label_gu": "સ્પેશિયલ સિવિલ સૂટ"},
                    {"value": "commercial_suit", "label_en": "Commercial Suit", "label_gu": "કોમર્શિયલ સૂટ"},
                    {"value": "civil_misc_app", "label_en": "Misc. Civil Application", "label_gu": "મિસ. સિવિલ અરજી"},
                    {"value": "criminal_case", "label_en": "Criminal Case", "label_gu": "ક્રિમિનલ કેસ"},
                    {"value": "criminal_complaint", "label_en": "Criminal Complaint", "label_gu": "ક્રિમિનલ ફરિયાદ"},
                    {"value": "sessions_case", "label_en": "Sessions Case", "label_gu": "સેશન્સ કેસ"},
                    {"value": "special_criminal_case", "label_en": "Special Criminal Case", "label_gu": "સ્પેશિયલ ક્રિમિનલ કેસ"},
                    {"value": "criminal_misc_app", "label_en": "Criminal Misc. Application", "label_gu": "ક્રિમિનલ મિસ. અરજી"},
                    {"value": "motor_accident_claim", "label_en": "MACP", "label_gu": "મોટર અકસ્માત ક્લેઈમ"},
                    {"value": "other", "label_en": "Other", "label_gu": "અન્ય"},
                ],
            },
            ...
            },
            {
                "key": "party_1_name",
                "label_en": "Party 1 Name",
                "label_gu": "પક્ષકાર - ૧ નુ નામ",
                "type": "text",
                "required": False,
                "source": "case_party_name",
                "mode": ["saved_case", "direct_template"],
                "placeholder": "પક્ષકાર - ૧ નુ નામ",
            },
            {
                "key": "party_2_role",
                "label_en": "Party 2 Role",
            ...
            },
            {
                "key": "party_2_name",
                "label_en": "Party 2 Name",
                "label_gu": "પક્ષકાર - ૨ નુ નામ",
                "type": "text",
                "required": False,
                "source": "case_opposite_party_name",
                "mode": ["saved_case", "direct_template"],
                "placeholder": "પક્ષકાર - ૨ નુ નામ",
            },
            {
                "key": "advocate_for",
                "label_en": "Advocate For",
            ...
            {
                "key": "absence_reason",
                "label_en": "Reason for Absence",
                "label_gu": "ગેરહાજર રહેવાનુ કારણ",
                "type": "select",
                "required": False,
                "options": [
                    {"value": "અનિવાર્ય સંજોગોના", "label_gu": "અનિવાર્ય સંજોગોના", "label_en": "અનિવાર્ય સંજોગોના"},
                    {"value": "બહારગામ ગયેલ હોવાના", "label_gu": "બહારગામ ગયેલ હોવાના", "label_en": "બહારગામ ગયેલ હોવાના"},
                    {"value": "માંદગીના", "label_gu": "માંદગીના", "label_en": "માંદગીના"},
                    {"value": "સામાજીક કાર્યોમા રોકાયેલ હોવાના", "label_gu": "સામાજીક કાર્યોમા રોકાયેલ હોવાના", "label_en": "સામાજીક કાર્યોમા રોકાયેલ હોવાના"},
                    {"value": "બીજી કોર્ટમા પણ મુદ્દત હોય જેથી બીજી કોર્ટમા ગયેલ હોવાના", "label_gu": "બીજી કોર્ટમા પણ મુદ્દત હોય જેથી બીજી કોર્ટમા ગયેલ હોવાના", "label_en": "બીજી કોર્ટમા પણ મુદ્દત હોય જેથી બીજી કોર્ટમા ગયેલ હોવાના"},
                    {"value": "અન્ય", "label_gu": "અન્ય", "label_en": "અન્ય"},
                ],
            },
            {
        ...
        "settings": {
            ...
            "english_font": "Times-Roman",
            "english_font_docx": "Times New Roman",
            "page_margin_left": 113.39,
            "page_margin_right": 113.39,
            "page_margin_top": 56.69,
            "page_margin_bottom": 56.69,
            "heading_size": 15,
            "heading_size_en": 16,
            "body_size": 13,
            "body_size_en": 14,
            "block_align": [
                {"contains": "સાહેબશ્રીની કોર્ટમાં", "align": "center", "bold": True, "indent": False},
                {"contains": "In the Court of the Hon'ble", "align": "center", "bold": True, "indent": False},
                {"prefix": "મુકામ :-", "contains": "મુકામ :-", "align": "center", "bold": False, "indent": False},
                {"prefix": "Place :-", "contains": "Place :-", "align": "center", "bold": False, "indent": False},
                {"contains": "નં. :", "align": "right", "bold": False, "indent": False},
                {"contains": "No. :", "align": "right", "bold": False, "indent": False},
                {"prefix": "વિરુદ્ધ", "contains": "વિરુદ્ધ", "align": "center", "bold": False, "indent": False},
                {"prefix": "Versus", "contains": "Versus", "align": "center", "bold": False, "indent": False},
                {"contains": "બાબત :- હાજરી મુક્તિ આપવા બાબત... (એક્ઝામ્પ્શન રીપોર્ટ)", "align": "center", "bold": True, "underline": True, "indent": False},
                {"contains": "Subject :- Application for Exemption from Personal Appearance ... (Exemption Report)", "align": "center", "bold": True, "underline": True, "indent": False},
                {"prefix": "સદર કામમાં", "align": "justify", "bold": False, "indent": True},
                {"prefix": "In the said matter", "align": "justify", "bold": False, "indent": True},
                {"prefix": "સદર કેસ", "align": "justify", "bold": False, "indent": True},
                {"prefix": "The said case is pending", "align": "justify", "bold": False, "indent": True},
                {"prefix": "તારીખ :", "align": "left", "bold": False, "indent": False},
...
સદર કેસ આપ નામદાર કોર્ટ સમક્ષ ચાલવા પર છે. જેની મુદ્દત આજ રોજની છે પરંતુ સદર કામના {{advocate_for_role}} આજરોજ {{absence_reason}} કારણોસર આપ નામદાર કોર્ટ સમક્ષ હાજર રહી શકે તેમ નથી. જેથી આજના દિવસ પૂરતી {{advocate_for_role}}ની વ્યક્તિગત હાજરી માફ રાખી સદર કેસમાં આગળની કાર્યવાહી કરવા યોગ્ય તે હુકમ કરવા મહેરબાની કરશોજી.
...
Subject :- Application for Exemption from Personal Appearance ... (Exemption Report)

In the said matter, we, the Advocate for {{advocate_for_role}}, humbly submit before this Hon'ble Court that...

The said case is pending for hearing before this Hon'ble Court. The date of hearing is fixed for today, but the {{advocate_for_role}} of the said matter is unable to remain present before this Hon'ble Court today due to the reason that {{absence_reason}}. Therefore, it is prayed to be pleased to exempt the personal appearance of the {{advocate_for_role}} for today and pass appropriate orders to proceed further in the case.
