    ...
    },
    {
        ...
        "fields": [
            ...
            {"key": "case_number", "label_en": "Case Number", "label_gu": "કેસ નંબર", "type": "text", "required": True, "source": "case_number", "mode": ["saved_case", "direct_template"], "placeholder": "દા.ત. ૧૦૧/૨૦૨૪"},
            {
                ...
                "mode": ["saved_case", "direct_template"],
                "options": [
                    {"value": "ફરીયાદી", "label_en": "Plaintiff / Complainant", "label_gu": "ફરીયાદી"},
                    {"value": "અરજદાર", "label_en": "Applicant / Petitioner", "label_gu": "અરજદાર"},
                    {"value": "વાદી", "label_en": "Plaintiff", "label_gu": "વાદી"},
                ],
            },
            {"key": "party_1_name", "label_en": "Party 1 Name", "label_gu": "પક્ષકાર - ૧ નું નામ", "type": "text", "required": True, "source": "case_party_name", "mode": ["saved_case", "direct_template"]},
            {
                "key": "party_2_role",
                ...
                "options": [
                    ...
                    {"value": "સામાવાળા", "label_en": "Respondent", "label_gu": "સામાવાળા"},
                    {"value": "પ્રતિવાદી", "label_en": "Defendant", "label_gu": "પ્રતિવાદી"},
                ],
            },
            {"key": "party_2_name", "label_en": "Party 2 Name", "label_gu": "પક્ષકાર - ૨ નું નામ", "type": "text", "required": True, "source": "case_opposite_party_name", "mode": ["saved_case", "direct_template"]},
            {
                ...
                "required": True,
                "options": [
                    {"value": "party_1", "label_en": "Party 1 side", "label_gu": "પક્ષકાર-૧ તરફથી"},
                    {"value": "party_2", "label_en": "Party 2 side", "label_gu": "પક્ષકાર-૨ તરફથી"},
                ],
            },
            {
            ...
            {"key": "date", "label_en": "Date", "label_gu": "તારીખ", "type": "date", "required": True},
            {"key": "place", "label_en": "Place", "label_gu": "સ્થળ", "type": "text", "required": False},
        ],
        "settings": {
            "page_size": "A4",
            "margin_top_cm": 2.0,
