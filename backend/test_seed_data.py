    ...
    },
    {
        ...
        "fields": [
            ...
            },
            {
                ...
                "required": False,
                "options": [
                    {"value": "ઘણી મુદ્દતથી", "label_en": "From several hearings", "label_gu": "ઘણી મુદ્દતથી"},
                    {"value": "આજ દિન સુધી", "label_en": "Till date", "label_gu": "આજ દિન સુધી"},
                ],
            },
            {
                "key": "date",
...
સદર કેસ આપ નામદાર કોર્ટમા આજ રોજ દલીલો પર છે. પરંતુ સદર કેસમાં {{closed_party_role}} પોતે જાતે કે તેમના વકીલશ્રી આજરોજ આપ નામદાર કોર્ટમા હાજર ન હોઈ, તેમજ કોઈ મુદ્દત રીપોર્ટ રજુ કરેલ ન હોઈ જેથી {{closed_party_role}} નો દલીલો કરવાનો હક બંધ કરી આગળની ન્યાયિક કાર્યવાહી કરવા યોગ્ય તે હુકમ કરવા મહેરબાની કરશોજી.
