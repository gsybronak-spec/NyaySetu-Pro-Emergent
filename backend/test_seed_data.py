...
""",
    },
    {
        ...
        "fields": [
            ...
            {"key": "party_1_name", "label_en": "Party 1 Name", "label_gu": "પક્ષકાર-૧નું નામ", "type": "text", "required": True, "source": "case_party_name", "mode": ["saved_case", "direct_template"], "placeholder": "પક્ષકાર-૧નું પૂરું નામ"},
            {
                "key": "party_2_role",
            ...
            {"key": "party_2_name", "label_en": "Party 2 Name", "label_gu": "પક્ષકાર-૨નું નામ", "type": "text", "required": True, "source": "case_opposite_party_name", "mode": ["saved_case", "direct_template"], "placeholder": "પક્ષકાર-૨નું પૂરું નામ"},
            {
                "key": "representing_party",
                "label_en": "Representing Party",
                "label_gu": "કોના તરફથી રજૂઆત / અરજી",
                "type": "radio",
                "required": True,
                "options": [
